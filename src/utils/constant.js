...
exports.HEADER = [
    ...
    {header: 'Hotel Name', key: 'hotelName', width: 10},
    {header: 'Address_Line1', key: 'address_line1', width: 15},
    {header: 'Address_Line2', key: 'address_line2', width: 10},
    {header: 'City', key: 'city', width: 10},
    {header: 'State', key: 'state', width: 10},
    {header: 'PostalCode', key: 'postal_code', width: 15},
    {header: 'Country', key: 'country', width: 10},
    {header: 'Amenities List', key: 'amenitiesList', width: 10},
    {header: 'Likes', key: 'likes', width: 10},
    {header: 'Current UserId', key: 'currentUserId', width: 10},
